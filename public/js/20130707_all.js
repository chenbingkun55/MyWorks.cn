$(document).ready(function(){
	...
	$("#title_bar").load("/index.php/Ajax/title_bar/rid/0/tid/0/lfid/0/uid/1/");
});
...
function tool_bar(str,index,lid,pid){
	...
	if (str=='m1'){
		...
		$("#tool_bar_"+str).load("/index.php/Ajax/tool_bar/menu/tool_bar_"+str+"/index/"+index+"/lid/"+lid+"/pid/"+pid+"/uid/1/");
	}	
}
...
function title_bar(rid,tid){
	...
	$("#title_bar").load("/index.php/Ajax/title_bar/rid/"+rid+"/tid/"+tid+"/uid/1/");
}
...
function resource_select(pid,rid,lfid){
	...
	$("#R"+rid+"LF"+lfid).load("/index.php/Ajax/resource_select/pid/"+pid+"/rid/"+rid+"/lfid/"+lfid+"/uid/1/");
}

function resource_conten(pid,rid,lfid,oid){
	//alert('欢迎进入 resource_conten'+' Pid='+pid+' Rid='+rid+' LFid='+lfid+' S_id='+oid);
	$("#conten_box").load("/index.php/Ajax/resource_conten/pid/"+pid+"/rid/"+rid+"/lfid/"+lfid+"/oid/"+oid+"/uid/1/");
}
